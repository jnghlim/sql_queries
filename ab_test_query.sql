...
-- Campaign Acceptance Column. If acceptedPreviousCampaign = 1 -> Control, Response = 1 -> Treatment, Both = 0 -> Neither
alter table marketing
drop column Campaign

select *,
CASE
	when Response = 1 then 'Treatment'
	when acceptedPreviousCmp = 1 then 'Control'
	else 'None'
END as Campaign
from marketing
